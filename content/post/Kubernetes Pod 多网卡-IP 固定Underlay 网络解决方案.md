---
title: Kubernetes Pod 多网卡、IP 固定Underlay 网络解决方案
date: 2023-04-11 14:50:33
type: categories
tags: 
  - kubernetes
keywords: kubernetes
...
[SpiderPool](https://spidernet-io.github.io/spiderpool)是一个 Kubernetes 的 IPAM 插件项目，其主要针对于 Underlay 网络的 IP 地址管理需求而设计**，能够为任何兼容第三方 IPAM 插件的 CNI 项目所使用。它克服了 Underlay 网络分配 IP 地址的复杂性，**使得 IP 分配的运维工作像一些 Overlay 网络模型一样简单**，同时，它拥有应用 IP 地址固定、IP 地址自动弹性扩缩容、 多网卡、双栈支持等特点。更多说明参考 SpiderPool 介绍 [2]。
...
![图片](https://gh-proxy.com/https://raw.githubusercontent.com/Ghostpanter/tuchuang/main/img/202304111431185.png)

## ## **03 安装**

根据 [Spiderpool 的官方文档](https://github.com/spidernet-io/spiderpool/blob/main/docs/usage/get-started-macvlan-zh_CN.md) 搭建了一套 Multus 、Macvlan、Veth 、Spiderpool 的环境，以下是笔者根据自身环境已创建的 SpiderSubnet 实例：
...
[1] [Antrea 文档](https://github.com/antrea-io/antrea/blob/main/docs/antrea-ipam.md#ippool-annotations-on-pod-available-since-antrea-15)

[2] [SpiderPool 功能介绍](https://github.com/spidernet-io/spiderpool)

[3] [Multus](https://github.com/k8snetworkplumbingwg/multus-cni)

[4] [Macvlan](https://github.com/containernetworking/plugins/tree/main/plugins/main/macvlan)

[5] [Calico](https://github.com/projectcalico/calico)

[6] [SRI-OV](https://github.com/k8snetworkplumbingwg/sriov-cni)

[7] [ipvlan](https://github.com/containernetworking/plugins/tree/main/plugins/main/ipvlan)

[8] [vlan](https://github.com/containernetworking/plugins/tree/main/plugins/main/vlan)

[9] [ovs](https://github.com/k8snetworkplumbingwg/ovs-cni)

[10] [Weave](https://github.com/weaveworks/weave)

[11] [Veth](https://github.com/spidernet-io/plugins)

[12] [手动建池](https://github.com/spidernet-io/spiderpool/blob/main/docs/usage/ippool-affinity-pod.md)

[13] [预留 IP](https://github.com/spidernet-io/spiderpool/blob/main/docs/usage/reserved-ip.md)

[14] [备用 IP 池](https://github.com/spidernet-io/spiderpool/blob/main/docs/usage/reserved-ip.md)

[15] [IP 回收机制](https://github.com/spidernet-io/spiderpool/blob/main/docs/usage/gc.md)

[16] [性能数据](https://github.com/spidernet-io/spiderpool/blob/main/docs/usage/performance-zh_CH.md)
