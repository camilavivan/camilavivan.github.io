---
title: kubeadm 部署 Kubernetes(v1.26.3)集群
date: 2023-04-13 11:34:33
type: categories
tags: 
  - kubernetes
keywords: kubernetes
...
|     HOST     |      IP       |        系统        |
| :----------: | :-----------: | :----------------: |
| k8s-master01 | 172.17.40.174 | Ubuntu 22.04.2 LTS |
|  k8s-work01  | 172.17.40.175 | Ubuntu 22.04.2 LTS |
|  k8s-work02  | 172.17.40.176 | Ubuntu 22.04.2 LTS |
...
sudo apt-get install vim iputils-ping net-tools
...
更新了软件仓库，我们就可以用 apt install 获取 kubeadm、kubelet 和 kubectl 这三个安装必备工具了。apt 默认会下载最新版本，但我们也可以指定版本号，比如指定 **1.26.3**：

```bash
# 安装指定版本
sudo apt install -y kubeadm=1.26.3-00 kubelet=1.26.3-00 kubectl=1.26.3-00
...
![图片](https://gh-proxy.com/https://raw.githubusercontent.com/Ghostpanter/tuchuang/main/img/202308031525679.png)
