...
![图片](https://gh-proxy.com/https://raw.githubusercontent.com/Ghostpanter/tuchuang/main/img/202307201109899.jpeg)
...
新的 `ResourcesAllocated` 字段表示正在进行中的大小调整操作，并由保存在节点检查点的状态驱动。在考虑节点上的可用空间时，调度器应该使用 `Spec.Containers[i].Resources` 和 `Status.ContainerStatuses[i].ResourcesAllocated` 中较大的那个。
...
![图片](https://gh-proxy.com/https://raw.githubusercontent.com/Ghostpanter/tuchuang/main/img/202307201354668.png)
...
![图片](https://gh-proxy.com/https://raw.githubusercontent.com/Ghostpanter/tuchuang/main/img/202307201354196.png)
